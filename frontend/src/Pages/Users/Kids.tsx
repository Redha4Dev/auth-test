...
import { ChevronLeft, ChevronRight, Copy, MoreVertical, Plus } from "lucide-react";
          ...
          <div className="flex justify-between items-center mb-4">
            ...
            <Dialog>
              <DialogTrigger asChild>
                <Button variant="outline">Add Kid <Plus/></Button>
              </DialogTrigger>
              <DialogContent className="sm:max-w-md">
                ...
                <div className="flex space-x-2">
                  <div className="grid w-full grid-cols-1 md:gird-cols-2 gap-2">
                    <Input placeholder="Name" onChange={(e) => {setKids({...kids, name: e.target.value})}}/>
                    <Input placeholder="Code" onChange={(e) => {setKids({...kids, code: e.target.value})}} />
                  </div>  
                  <div className="grid w-full grid-cols-1 md:gird-cols-2 gap-2">
                    <Select onValueChange={(v) => {setKids({...kids, gender: v})}}>
