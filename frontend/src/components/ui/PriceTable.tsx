    ...
    <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <div className="hidden mt-16 lg:block">
            <table className="w-full">
                ...
                <tbody>
                    <tr>
                        <td className="py-4 pr-4 font-medium border-b border-gray-200">Classes Number</td>
                    ...
                    <tr>
                        <td className="py-4 pr-4 font-medium border-b border-gray-200">Psycho account</td>
                    ...
                    <tr>
                        <td className="py-4 pr-4 font-medium border-b border-gray-200">????</td>
                    ...
                    <tr>
                        ...
                        <td className="px-4 py-6 text-center">
                            <a href="/SignUp" title="" className="inline-flex items-center font-semibold text-blue-600 hover:text-blue-700">
                                Get Started
                        ...
                        <td className="px-4 py-6 text-center text-white bg-yellow-500 rounded-b-xl">
                            <a href="/SignUp" title="" className="inline-flex items-center font-semibold text-white">
                                Get Started
                                <svg className="w-4 h-4 ml-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                    <path fill-rule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd"></path>
                                </svg>
